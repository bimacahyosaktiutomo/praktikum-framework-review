...
def student_create(request):
    ...
    return render(request, 'student/create.html', {'form':
    StudentsForm()}) # Pastikan Anda mengirimkan form ke template
...
def student_update(request, student_id):
    ...
    # Mengirim PUT request ke API
        ...
        return render(request, 'student/update.html', {'form':
        StudentsForm(initial=student), 'student': student})
